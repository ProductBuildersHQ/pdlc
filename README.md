...
| [Requirements & Acceptance](specification/requirements-acceptance.md) | Requirement-ID registry with stability rules; executable acceptance tests (browser-driven journeys) tied to requirement IDs |
